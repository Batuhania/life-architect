...
```
”œ”€”€ index.html          # App shell & all modals
”œ”€”€ style.css           # Design system (60KB of pure CSS)
”œ”€”€ script_v9.js        # App logic, i18n, gamification
”œ”€”€ sw.js               # Service Worker for offline support
”œ”€”€ manifest.json       # PWA manifest
”œ”€”€ icon.svg            # Vector app icon
”œ”€”€ icon-192x192.png    # PWA icon (192px)
